  ...
  return (
    <main>
      <header>
        ...
        <nav className="flex overflow-x-auto border-b border-white/10 py-4 mt-16 lg:mt-0 bg-white">
          <ul
            role="list"
        ...
        {/* Heading */}
        <div className="flex flex-col items-start bg-white border-b  justify-between gap-x-8 gap-y-4 px-4 py-4 sm:flex-row sm:px-6 lg:px-8">
          <div>
            <div className="flex items-center gap-x-3">
              ...
              <h1 className="flex gap-x-3 text-xl leading-7">
                <span className="font-semibold ">{data.mapData.map_name}</span>
              </h1>
            </div>
            <p className="mt-1 text-xs leading-6 text-gray-400 font-normal">
        ...
        {/* Stats */}
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 bg-white">
          {stats.map((stat, statIdx) => (
            ...
            >
              ...
              <p className="mt-2 flex items-baseline gap-x-1">
                <span className="text-xl md:text-4xl font-semibold tracking-tight ">
                  {stat.value}
                </span>
                {stat.unit ? (
