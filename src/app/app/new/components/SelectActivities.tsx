...
export const SelectActivities = () => {
  ...
  useLayoutEffect(() => {
    ...
    if (checkbox.current) {
      (checkbox.current as HTMLInputElement).indeterminate = isIndeterminate;
    }
  }, [selectedPeople]);
      ...
      <div className="px-4 py-5 sm:p-6 flex justify-between">
        <div>
          ...
          <div className="mt-4 max-w-xl text-sm text-gray-500">
            <p>Select the activities you want to include in your ExploreMap</p>
          </div>
        </div>
